...
class OptionsMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new MyCustomAppBar2(height: 15, context: context, title: "Options"),
      body: SafeArea(
            child: Container(
          color: Colors.white,
          child: Stack(
...
class EventsMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new MyCustomAppBar2(height: 15, context: context, title: title),
      body: SafeArea(
          child: Container(
          color: Colors.white,
          child: Stack(
...
class NetworkingMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new MyCustomAppBar2(height: 15, context: context, title: "Networking"),
      body: SafeArea(
          child: Container(
          color: Colors.white,
          child: Stack(
...
class FoodMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new MyCustomAppBar2(height: 15, context: context, title: "Food"),
      body: SafeArea(
          child: new Container(
          color: Colors.white,
          child: Stack(
...
class WcMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new MyCustomAppBar2(height: 15, context: context, title: "Wc"),
      body: SafeArea(
            child: Container(
          color: Colors.white,
          child: Stack(
...
class Exits extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new MyCustomAppBar2(height: 15, context: context, title: "Exits"),
